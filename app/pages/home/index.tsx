      ...
      <div className="mt-[-50px] content absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 text-center">
        <div className="mt-[250px] fire">
          <div className="text-white relative">
            ...
            <h1 className="text-5xl md:text-8xl barlow-semi-condensed-black-italic font-bold mb-4 relative z-10 Blazing">SAVORS</h1>
            <p className="text-lg md:text-xl dancing-script-chefathome">Chef at Home</p>
        ...
        <div className='w-[8em] h-[3em] mt-[100%] p-2 font-semibold rounded-3xl ml-[25%] flex justify-center z-1 border-solid border-2 bg-white md:ml-[37%] md:mt-[50%]'>Learn More</div>
      </div>
    </div>
  );
}
